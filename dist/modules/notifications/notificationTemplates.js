export const templates = {
    orderPlaced: (crop, quantity, buyerName) => ({
    ...
    orderConfirmed: (crop, quantity, farmerName) => ({
    ...
    orderCancelled: (crop, cancelledBy) => ({
    ...
    priceAlert: (crop, direction, advice) => ({
    ...
    listingExpiringSoon: (crop, daysLeft) => ({
    ...
    listingFirstOrder: (crop, buyerName) => ({
    ...
    farmerAssigned: (farmerName, agentName) => ({
    ...
    transactionFacilitated: (crop, amount) => ({
