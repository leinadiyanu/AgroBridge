...
export class UserController {
    constructor() {
        ...
        this.addFarmer = async (req, res, next) => {
            try {
                const result = await this.service.addFarmer(req.user.id, req.user.role, req.body);
                res
                    .status(201)
                    .json({
                    success: true,
        ...
        this.getMyFarmers = async (req, res, next) => {
            try {
                const farmers = await this.service.getMyFarmers(req.user.id, req.user.role);
