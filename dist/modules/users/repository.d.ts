...
export declare class UserRepository {
    ...
    findFarmerByPhone(phoneNumber: string): Promise<{
        role: import("@prisma/client").$Enums.Role;
        id: string;
        phoneNumber: string;
        email: string | null;
    ...
    linkAgentFarmer(agentId: string, farmerId: string): Promise<{
        id: string;
        createdAt: Date;
        farmerId: string;
        agentId: string;
    }>;
    findExistingLink(agentId: string, farmerId: string): Promise<{
        id: string;
        createdAt: Date;
        farmerId: string;
        agentId: string;
    } | null>;
    getManagedFarmers(agentId: string): Promise<({
        farmer: {
            id: string;
            phoneNumber: string;
            name: string;
