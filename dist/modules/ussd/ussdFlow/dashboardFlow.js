...
5. Earnings`,
        ...
        postCrop: {
            ...
            validate: (input) => /^[a-zA-Z\s]{2,}$/.test(input),
        ...
        postDate: {
            ...
            validate: (input) => /^\d{2}\/\d{2}\/\d{4}$/.test(input),
...
1. View Farmers
2. Add Farmer`,
            validate: (input) => ["1", "2"].includes(input),
            error: `CON Invalid option
1. View Farmers
2. Add Farmer`,
            next: (input) => input === "1" ? "viewFarmers" : "addFarmerPhone",
        },
        addFarmerPhone: {
            prompt: "CON Enter farmer's phone number",
            validate: (input) => /^\d{10,13}$/.test(input),
...
// ─── Role router ─────────────────────────────────────────────────────────────
export const dashboardFlowFor = (role) => {
    const map = {
