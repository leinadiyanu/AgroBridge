    ...
    steps: {
        choosePrediction: {
            prompt: "CON Price Intelligence\n" +
                ...
                "2. Best time to sell\n" +
                "0. Back",
            validate: (input) => ["1", "2", "0"].includes(input),
            error: "CON Invalid option. Choose 1, 2, or 0:",
            next: (input) => {
                if (input === "1")
                    return "enterCropForPredict";
                if (input === "2")
                    return "enterCropForBestTime";
                return "back";
            },
        },
        ...
        enterStateForPredict: {
            ...
            transform: (input, data) => `${data.enterCropForPredict}|${input}`, // bundle crop|state together
        ...
        back: {
            prompt: (role, name) => `CON Welcome ${name}\n` +
                "1. Post Produce\n" +
                "2. My Listings\n" +
                "3. Incoming Orders\n" +
                "4. Price Prediction\n" +
...
//# sourceMappingURL=predictionFlow.js.map